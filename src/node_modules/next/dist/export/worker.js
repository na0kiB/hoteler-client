...
async function exportPage({ parentSpanId , path , pathMap , distDir , outDir , viewsDir , pagesDataDir , renderOpts , buildExport , serverRuntimeConfig , subFolders , serverless , optimizeFonts , optimizeCss , disableOptimizedLoading , httpAgentOptions , serverComponents  }) {
    ...
    return exportPageSpan.traceAsyncFn(async ()=>{
        ...
        try {
            ...
            if (serverless) {
                ...
                const { Component , ComponentMod , getServerSideProps , getStaticProps , pageConfig ,  } = await (0, _loadComponents).loadComponents(distDir, page, serverless, serverComponents, viewsDir);
                const ampState = {
