...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target ='server' , viewsDir  }) {
    var ref40, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref20, ref21, ref22;
    ...
    if (useSWCLoader) {
        ...
        const binaryTarget = (ref23 = require('./swc')) === null || ref23 === void 0 ? void 0 : (ref24 = ref23.getBinaryMetadata) === null || ref24 === void 0 ? void 0 : (ref25 = ref24.call(ref23)) === null || ref25 === void 0 ? void 0 : ref25.target;
    ...
    const getBabelOrSwcLoader = ()=>{
        ...
        if (useSWCLoader && (config === null || config === void 0 ? void 0 : (ref = config.experimental) === null || ref === void 0 ? void 0 : ref.swcTraceProfiling)) {
            ...
            ref38, ref39;
            (ref38 = require('./swc')) === null || ref38 === void 0 ? void 0 : (ref39 = ref38.initCustomTraceSubscriber) === null || ref39 === void 0 ? void 0 : ref39.call(ref38, _path.default.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return useSWCLoader ? {
    ...
    const clientEntries = isClient ? {
        ...
        ...config.experimental.viewsDir ? {
            [_constants1.CLIENT_STATIC_FILES_RUNTIME_MAIN_ROOT]: `./` + _path.default.relative(dir, _path.default.join(_constants.NEXT_PROJECT_ROOT_DIST_CLIENT, 'root-next.js')).replace(/\\/g, '/')
        } : {}
    } : undefined;
    ...
    const looseEsmExternals = ((ref40 = config.experimental) === null || ref40 === void 0 ? void 0 : ref40.esmExternals) === 'loose';
    ...
    if (resolvedBaseUrl) {
        var ref26, ref27;
        (ref26 = webpackConfig.resolve) === null || ref26 === void 0 ? void 0 : (ref27 = ref26.modules) === null || ref27 === void 0 ? void 0 : ref27.push(resolvedBaseUrl);
    }
    if ((jsConfig === null || jsConfig === void 0 ? void 0 : (ref12 = jsConfig.compilerOptions) === null || ref12 === void 0 ? void 0 : ref12.paths) && resolvedBaseUrl) {
        var ref28, ref29;
        (ref28 = webpackConfig.resolve) === null || ref28 === void 0 ? void 0 : (ref29 = ref28.plugins) === null || ref29 === void 0 ? void 0 : ref29.unshift(new _jsconfigPathsPlugin.JsConfigPathsPlugin(jsConfig.compilerOptions.paths, resolvedBaseUrl));
    }
    ...
    const cache = {
        ...
        version: `${"12.1.7-canary.3"}|${configVars}`,
    ...
    if (typeof config.webpack === 'function') {
        ...
        if (((ref30 = webpack5Config.experiments) === null || ref30 === void 0 ? void 0 : ref30.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref31 = webpack5Config.experiments) === null || ref31 === void 0 ? void 0 : ref31.lazyCompilation) === 'object' && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref32;
        const rules = ((ref32 = webpackConfig.module) === null || ref32 === void 0 ? void 0 : ref32.rules) || [];
    ...
    if (config.experimental.craCompat && ((ref21 = webpackConfig.module) === null || ref21 === void 0 ? void 0 : ref21.rules) && webpackConfig.plugins) {
    ...
    var ref33;
    const hasUserCssConfig = (ref33 = (ref22 = webpackConfig.module) === null || ref22 === void 0 ? void 0 : ref22.rules.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include)
    )) !== null && ref33 !== void 0 ? ref33 : false;
    if (hasUserCssConfig) {
        var ref34, ref35, ref36, ref37;
        ...
        if ((ref34 = webpackConfig.module) === null || ref34 === void 0 ? void 0 : ref34.rules.length) {
        ...
        if ((ref35 = webpackConfig.plugins) === null || ref35 === void 0 ? void 0 : ref35.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true
            );
        }
        if ((ref36 = webpackConfig.optimization) === null || ref36 === void 0 ? void 0 : (ref37 = ref36.minimizer) === null || ref37 === void 0 ? void 0 : ref37.length) {
